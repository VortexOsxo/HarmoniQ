...
/** Flush pending microtasks so sequential awaits in the service complete */
...
describe('SimulationTemporalGraphService', () => {
  ...
  beforeEach(() => {
    mockGraphService = {
      ...
      getStandardTrace: vi.fn().mockReturnValue({ x: [], y: [], type: 'scatter', line: { shape: 'spline', color: '#000', width: 4 }, fill: 'tozeroy', fillcolor: 'rgba(0,0,0,0.1)', hovertemplate: '' }),
