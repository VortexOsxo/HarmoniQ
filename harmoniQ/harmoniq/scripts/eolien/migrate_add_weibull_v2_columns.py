"""
Add Weibull v2 metadata columns to eoliennes_parc in a non-destructive and idempotent way.
"""
...
def migrate() -> None:
    with engine.begin() as conn:
        ...
        for column_name, column_type in WEIBULL_V2_COLUMNS.items():
    ...
    print("Weibull v2 schema migration complete.")
