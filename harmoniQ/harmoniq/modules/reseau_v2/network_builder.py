...
# Valeurs approximatives (ordre de grandeur par niveau de tension),
# utilisées par auto_scale_line_capacities() pour calculer num_parallel.
...
def build_pypsa_network(
    ...
    # PyPSA 1.x ne calcule pas automatiquement x/r à partir du type et de la longueur.
    # Il faut l'appeler explicitement après avoir ajouté les line_types et les lignes.
